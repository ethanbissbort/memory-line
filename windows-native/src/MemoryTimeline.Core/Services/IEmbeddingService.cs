...
public interface IEmbeddingService
{
    ...
    /// <summary>
    /// Checks whether the embedding service is usable — i.e. an API key is configured.
    /// The Connections UI uses this to show a call-to-action state instead of failing silently.
    /// </summary>
    /// <returns>True when an embedding API key is configured</returns>
